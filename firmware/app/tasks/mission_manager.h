...
/* Mission Specific Macros */
#if defined (CONFIG_MISSION_CIMATELITE) && (CONFIG_MISSION_CIMATELITE == 1)

    #define MISSION_OPERATION_MODES                        4U

    /* Mission Operation Modes */
    #define OBDH_MODE_DEPLOYMENT                0x00U
    #define OBDH_MODE_NORMAL                    0X01U
    #define OBDH_MODE_STAND_BY                  0X02U
    #define OBDH_MODE_FDIR                      0x03U
    ...
    #define EV_DEPLOYMENT_COMPLETE                         (0x0008U)
