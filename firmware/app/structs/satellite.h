...
typedef enum {
    ...
    PKT_ID_UPLINK_CLEAR_CIMATELITE    =  0x51,
    PKT_ID_UPLINK_GET_PAYLOAD_COUNT   =  0X52,
    PKT_ID_DOWNLINK_GET_PAYLOAD_COUNT = 0x53,
    PKT_ID_UPLINK_PCD_TRANSMIT_PAYLOAD = 0x54,
    PKT_ID_DOWNLINK_PAYLOAD_TELEMETRY = 0X55
} packet_id_e;
